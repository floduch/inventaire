...
public class HRArrayAdapter<T> extends BaseAdapter implements Filterable {
     ...
     */
    public static inventaire.materiel.HRArrayAdapter<CharSequence> createFromResource(Context context,
                                                                                                 int textArrayResId, int textViewResId) {
        CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new inventaire.materiel.HRArrayAdapter<CharSequence>(context, textViewResId, strings);
    }
